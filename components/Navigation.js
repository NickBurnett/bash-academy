                ...
                <ul id='nav-list'>
                    ...
                    <Link href='/faq'>
                        <li className='nav-item' style={{ '--i': '1' }}>
                            <svg style={{ '--factor': '1', width: 'calc(var(--size) * var(--factor))', height: 'calc(var(--size) * var(--factor))'}}focusable="false" data-prefix="fas" data-icon="question" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
