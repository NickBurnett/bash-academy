    ...
    render() {
        setTimeout(() => {
            function callback() {
                ...
                const arr = nav.children[1].children
                let i = 1
                for (let e of arr) {
                    setTimeout(() => {
                        show(e)
        ...
        return (
            <div id='navigation'>
                <div id='nav-logo'>
                    ...
                    <div style={{ fontWeight: 'bolder' }}>v0.0.0</div>
                </div>
                <ul id='nav-list'>
                    {/* LEARN */}
                    <li className='nav-item hidden' style={{ '--i': '0' }}>
                    ...
                    {/* FAQ */}
                    <li className='nav-item hidden' style={{ '--i': '1' }}>
                        <svg style={{ '--factor': '0.95', width: 'calc(var(--size) * var(--factor))', height: 'calc(var(--size) * var(--factor))'}}focusable="false" data-prefix="fas" data-icon="question" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                    ...
                    {/* SIGNIN/SIGNOUT */}
                    <li className='nav-item hidden' style={{ '--i': '2' }}>
                        <svg focusable="false" data-prefix="fas" data-icon="sign-in-alt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
